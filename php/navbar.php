    ...
    <div class="modal-content-card" style="height: 100%; border-radius: 3% 0 0 3%; background-color: #001d2f; color: #e3cbbc; padding-left: 5%; padding-right: 5%;"> 
      ...
      <div class="modal-body" style="overflow-y: auto; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: calc(100% - 60px); padding-top: 20px;"> 
        ...
        <div style="display: flex; justify-content: space-between; width: 100%; margin-top: 5%;">
          ...
          <button type="button" onclick="location.href='ver_carrinho.php'" style="width: 48%; padding: 20%; background-color: #0c344b; border-radius: 10%; margin-bottom: 5%; border: none; font-size: 1.2rem; position: relative; cursor: pointer;">
        ...
        <div style="display: flex; justify-content: space-between; width: 100%; margin-top: 10px;"> 
          <button type="button" onclick="location.href='home.php'" style="width: 48%; padding: 20%; background-color: #0c344b; border-radius: 10%; margin-bottom: 5%; border: none; font-size: 1.2rem; position: relative; cursor: pointer;">
          ...
          <button 
    type="button" 
    onclick="if (confirm('Tem certeza que deseja sair?')) location.href='../backend/logout.php';" 
    style="width: 48%; padding: 20%; background-color: #0c344b; border-radius: 10%; margin-bottom: 5%; border: none; font-size: 1.2rem; position: relative; cursor: pointer;">
    <!-- Ícone -->
    <i 
        class="bi bi-box-arrow-right" 
        style="font-size: 1.5rem; color: #e3cbbc; position: absolute; left: 10px; top: 10px;">
    </i>
    <!-- Texto -->
    <span 
        style="color: #e3cbbc; font-size: 1rem; position: absolute; bottom: 10px; left: 10px; font-weight: bold; font-family: 'League Spartan', sans-serif; text-transform: uppercase;">
        Sair
    </span>
</button>
        </div>
